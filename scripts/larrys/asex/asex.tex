...
\hlstd{QUICKLY} \hlkwb{<-} \hlstd{F}                    \hlcom{# if T, shortcut the 100 millenium sim}
...
\dofig{asex-figs-mine/Fig-S10A.pdf}{Population structure, facultative sexual, ``complex trait''}{fig:s10b}
...
L-genotype's rise is quicky reversed as homozygous non-L genotypes out-compete and/or interbreed
