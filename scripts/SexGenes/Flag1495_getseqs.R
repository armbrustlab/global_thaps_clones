...
load("~/Dropbox/Julie/Tps7_2_08_2013/SexGenes/full.tables.flagellar.rda")

## list of 7 dataframes with order 1007, 1012, 1013, 1014, 1015, 3367, 1335
t<- full.tables.flagellar
...
write.fasta(seqs, names = c("1007", "1012", "1013", "1014", "1015", "3367", "1335"), nbchar = 60, file.out = "Tps7_1495_flagellar.fasta", open = "w")
write.fasta(ref, names = "ref", nbchar = 60, file.out = "Tps7_1495_flagellar.fasta", open = "a")
